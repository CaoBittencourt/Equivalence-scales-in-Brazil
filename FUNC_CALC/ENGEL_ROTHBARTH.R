...
# 2. X FUNÇÃO DE REGRESSÃO OLS (ENGEL E ROTHBARTH) FLEXÍVEL ---------------------
...
#     filter(grepl(']', term)) %>%
#     mutate(
#       equivalence.scale = ref.estimate.rel*(na.h - na.r) + coef.rel*(nc.h - nc.r) + qtd_morador.estimate.rel*log(nh/nr),
#       equivalence.scale = exp(equivalence.scale)*(nh/nr),
